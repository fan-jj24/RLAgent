        ...
        try:
            if isinstance(asset_id, str):
                ...
                for val in asset_id:
                    tmp_path += val
                    tmp_path += "&"
                data_assets_dir = str(assets_dir / tmp_path)
                norm_stats = _normalize.load(_download.maybe_download(data_assets_dir))
                logging.info(f"Loaded norm stats from {data_assets_dir}")
                return norm_stats
...
class TrainConfig:
    ...
    model: Any = dataclasses.field(default_factory=pi0.Pi0Config)
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotAlohaDataConfig(
            # repo_id=["stack_50_8", "stack_50_9", "stack_50_10", "stack_50_11", "stack_50_12", "stack_50_13"],  # your datasets repo_id
            # repo_id="stack_50_8",
            #repo_id=["stack_50_4", "stack_50_5", "stack_50_6", "stack_50_7"],  # your datasets repo_id
            repo_id=["stack_50_1", "stack_50_2", "stack_50_3", "stack_50_7", "stack_50_5", "stack_50_6",],  # your datasets repo_id
            #repo_id="stack_50_1",
            adapt_to_pi=False,
    ...
    TrainConfig(
        ...
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            repo_id="stack_50_8",  # your datasets repo_id
            adapt_to_pi=False,
            repack_transforms=_transforms.Group(inputs=[
                _transforms.RepackTransform({
                    "images": {
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader("/home/anker/robotwin/Pi0-RL-RoboTwin/pretrained_params/params_0"),
        num_train_steps=30000,
